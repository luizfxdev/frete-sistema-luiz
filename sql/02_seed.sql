-- Senha padrão: admin123 (texto plano para o projeto avaliativo)
INSERT INTO usuario (nome, email, senha) VALUES
('Administrador', 'admin@nextlog.com', 'admin123');

INSERT INTO cliente (razao_social, nome_fantasia, cnpj, inscricao_estadual, tipo, logradouro, numero, complemento, bairro, municipio, uf, cep, telefone, email, status) VALUES
('Indústria Alfa LTDA',     'Alfa',     '11222333000181', '123456789', 'REMETENTE',    'Av. Industrial',     '1000', 'Galpão 3', 'Distrito Industrial', 'Recife',     'PE', '52010000', '8130001000', 'contato@alfa.com.br',  'ATIVO'),
('Comércio Beta SA',        'Beta',     '22333444000172', '987654321', 'DESTINATARIO', 'Rua das Flores',     '250',  NULL,       'Centro',              'João Pessoa', 'PB', '58010000', '8330002000', 'contato@beta.com.br',   'ATIVO'),
('Distribuidora Gama LTDA', 'Gama',     '33444555000163', '456789123', 'AMBOS',        'Rod. BR-101',        'KM 12',NULL,       'Rural',               'Maceió',     'AL', '57000000', '8230003000', 'contato@gama.com.br',   'ATIVO');

INSERT INTO motorista (nome, cpf, data_nascimento, telefone, cnh_numero, cnh_categoria, cnh_validade, tipo_vinculo, status) VALUES
('João da Silva',     '52998224725', '1985-04-12', '81988880001', '12345678901', 'E', '2027-12-31', 'FUNCIONARIO', 'ATIVO'),
('Carlos Pereira',    '11144477735', '1990-08-23', '83988880002', '22345678902', 'D', '2026-06-30', 'AGREGADO',    'ATIVO'),
('Roberto Souza',     '93541134780', '1978-01-05', '82988880003', '32345678903', 'E', '2028-03-15', 'TERCEIRO',    'ATIVO');
