...
CREATE TABLE usuario (
    ...
    CONSTRAINT chk_usuario_role CHECK (role IN ('ADMIN', 'GESTOR', 'MOTORISTA'))
);
...
CREATE TABLE cliente (
    ...
    CONSTRAINT chk_cliente_tipo_documento CHECK (tipo_documento IN ('CPF', 'CNPJ')),
...
CREATE INDEX idx_motorista_usuario ON motorista(id_usuario);
